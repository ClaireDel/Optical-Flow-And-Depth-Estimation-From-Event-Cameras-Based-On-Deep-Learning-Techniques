...
def initialize_tester(config):
    ...
    if config['subtype'].lower() == 'warm_start':
        return t.TestRaftEventsWarm
    # Classic
    else:
        return t.TestRaftEvents
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--path', default='C:/Users/clair/Desktop/THESIS/Code_v2/E-RAFT-main/OUTPUT_DIRECTORY/', type=str, help="Dataset path") #Code_v2/E-RAFT-main/mvsec_outdoor_day_1_45Hz - E-RAFT-main/OUTPUT/
