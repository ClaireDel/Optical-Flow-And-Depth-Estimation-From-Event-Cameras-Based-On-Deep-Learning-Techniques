...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--output_directory', default='C:/Users/clair/Desktop/THESIS/Code_v2/E-RAFT-main/OUTPUT/', type=str, help="Dataset path") #Code_v2/E-RAFT-main/mvsec_outdoor_day_1_45Hz
