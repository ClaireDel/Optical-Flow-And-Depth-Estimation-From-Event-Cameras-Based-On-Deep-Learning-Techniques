...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--path_to_model', default='C:/Users/clair/Desktop/THESIS/CODE_v2/Depth-Event/pretrained/E2DEPTH_si_grad_loss_mixed.pth.tar', type=str,
                        help='path to model weights')
    parser.add_argument('-i', '--input_folder', default='C:/Users/clair/Desktop/THESIS/CODE_v2/Depth-Event/data/test_sequence_00_town10/events/voxels/', type=str,
    ...
    # display box (at the end) in inference options TRUE
    # show event (at the end) in inference options TRUE
