def set_inference_options(parser):
    ...
    parser.add_argument('-o', '--output_folder', default='C:/Users/clair/Desktop/Depth-Event/output/video.mp4', type=str)  # if None, will not write the images to disk
...
def set_depth_inference_options(parser):
    ...
    parser.add_argument('-o', '--output_folder', default='tmp', type=str)  # if None, will not write the images to disk
    parser.add_argument('--dataset_name', default='reconstruction', type=str)
    ...
    parser.set_defaults(save_color_map=True)
